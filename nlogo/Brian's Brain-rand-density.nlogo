...
to setup-random
  clear-all
  set initial-density precision random-float 1 2
  ask patches
...
<experiments>
  <experiment name="experiment" repetitions="3000" runMetricsEveryStep="true">
    ...
    <go>go</go>
    <timeLimit steps="1"/>
    <exitCondition>count patches with [pcolor = white] = 0</exitCondition>
    <metric>initial-density</metric>
    <metric>count patches with [pcolor = white]</metric>
  </experiment>
  <experiment name="experiment2" repetitions="300000" runMetricsEveryStep="false">
    <setup>setup-random</setup>
    <go>go</go>
    <timeLimit steps="1"/>
    <exitCondition>count patches with [pcolor = white] = 0</exitCondition>
  ...
  <experiment name="experiment3" repetitions="300000" runMetricsEveryStep="false">
    <setup>setup-random</setup>
    <go>go</go>
    <timeLimit steps="2"/>
    <exitCondition>count patches with [pcolor = white] = 0</exitCondition>
  ...
  <experiment name="mainExperiment" repetitions="30000" runMetricsEveryStep="false">
    <setup>setup-random</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <exitCondition>count patches with [pcolor = white] = 0</exitCondition>
